        ...
        <div className="space-y-4">
          ...
          {isGuestsInputOpen && (
            <div className="h-16 bg-zinc-900 px-4 flex items-center rounded-xl shadow-shape gap-3">
              ...
              <button className="bg-lime-300 text-lime-950 flex items-center gap-2 rounded-lg px-5 py-2 font-medium transition-colors duration-200 hover:bg-lime-400">
        ...
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center">
          <div className="bg-zinc-900 w-[640px] rounded-xl py-5 px-6 shadow-shape space-y-5">
            ...
            >
              ...
              <button
                type="submit"
                className="bg-lime-300 text-lime-950 flex items-center gap-2 rounded-lg px-5 py-2 font-medium transition-colors duration-200 hover:bg-lime-400"
              >
